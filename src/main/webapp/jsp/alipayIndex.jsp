...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=../../../../../../支付宝/WebContent/alipay.trade.page.pay.jsp method=post
              target="_blank">
		...
		<form name=tradequery action=../../../../../../支付宝/WebContent/alipay.trade.query.jsp method=post
              target="_blank">
		...
		<form name=traderefund action=/jsp/alipay.trade.refund.jsp method=post
              target="_blank">
				<div id="body3" class="tab-content" name="divcontent">
					<dl class="content">
						<dt>商户订单号 ：</dt>
						<dd>
							<input id="WIDTRout_trade_no" value="${requestScope.order.oid}" name="WIDTRout_trade_no"  />
						</dd>
						<hr class="one_line">
						<dt>支付宝交易号 ：</dt>
						<dd>
							<input id="WIDTRtrade_no" name="WIDTRtrade_no" value="" />
						</dd>
						<hr class="one_line">
						<dt>退款金额 ：</dt>
						<dd>
							<input id="WIDTRrefund_amount" value="${requestScope.order.total}" name="WIDTRrefund_amount"   />
						</dd>
						<hr class="one_line">
						<dt>退款原因 ：</dt>
						<dd>
		...
		<form name=traderefundquery
              action=../../../../../../支付宝/WebContent/alipay.trade.fastpay.refund.query.jsp method=post
              target="_blank">
		...
		<form name=tradeclose action=../../../../../../支付宝/WebContent/alipay.trade.close.jsp method=post
              target="_blank">
